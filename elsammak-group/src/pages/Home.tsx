...
const Home = () => {
 ...
 <motion.h1 variants={fadeUp} className="text-4xl md:text-6xl font-black mb-6 leading-tight drop-shadow-lg">
 {t('hero.title')}
 </motion.h1>
 ...
 <Button to="/about" size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-[var(--color-primary)] hover:-translate-y-1">
 {t('common.learn_more')}
 </Button>
 </motion.div>
 </motion.div>
 ...
 <img src="https://images.unsplash.com/photo-1556761175-5973dc0f32d7?auto=format&fit=crop&q=80" alt="Business Meeting" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
