...
const FloatingChat = () => {
 ...
 {/* WhatsApp */}
 <a
 href="https://api.whatsapp.com/send?phone=201234567890" target="_blank" rel="noopener noreferrer"
 ...
 {/* Messenger */}
 <a
 href="https://m.me/company_username" // Replace with actual messenger link
 target="_blank"
 rel="noopener noreferrer"
 className="w-14 h-14 bg-gradient-to-tr from-blue-600 to-indigo-500 rounded-full flex items-center justify-center text-white shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300 group"
