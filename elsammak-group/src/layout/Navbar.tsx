...
const Navbar = () => {
 ...
 return (
 <nav className="sticky top-0 z-50 w-full bg-[var(--bg-color)]/90 backdrop-blur-md border-b border-gray-200 transition-colors duration-300 shadow-sm">
 ...
 <span className="w-8 h-8 bg-gradient-to-tr from-[var(--color-primary)] to-[var(--color-gold)] rounded-sm flex items-center justify-center text-white text-lg font-black tracking-widest">
 E
 </span>
 <span className="hidden sm:block">El-Sammak Group</span>
 </Link>
 </div>
